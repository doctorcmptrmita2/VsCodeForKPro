...
export const webviewMessageHandler = async (
	...
	switch (message.type) {
		...
		case "requestRouterModels":
			...
			const candidates: { key: RouterName; options: GetModelsOptions }[] = [
				...
				},
				{
					...
					options: {
						provider: "roo",
						baseUrl: process.env.ROO_CODE_PROVIDER_URL ?? "https://api.codexflow.dev/proxy",
		...
		case "openKeyboardShortcuts": {
			// Open VSCode keyboard shortcuts settings and optionally filter to show the CodexFlow commands
